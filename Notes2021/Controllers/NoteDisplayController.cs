    ...
    public class NoteDisplayController : NController
    {
        ...
        public async Task<IActionResult> EnterFile(NoteDisplayViewModel1 model)
        {
            ...
            if (nf != null)
            {
                ...
                {
                    UserAuxData user = NoteDataManager.GetUserAuxData(_userManager, User, _db);
        ...
        public async Task<IActionResult> Create(TextViewModel model)
        {
            ...
            UserAuxData me = NoteDataManager.GetUserAuxData(_userManager, User, _db);
        ...
        [ValidateAntiForgeryToken]
        //[ValidateInput(false)]
        public async Task<IActionResult> Edit(TextViewModel nc)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult MailFileAsHtml(ForwardViewModel fv)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult MailStringAsHtml(ForwardViewModel fv)
        {
            bool toall = fv.toAllUsers;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Forward(ForwardViewModel fv)
        {
            if (fv == null)
            {
                return BadRequest();
