...
namespace Notes2021.Controllers
{
    ...
    public class ExportController : NController
    {
        ...
        public async Task<MemoryStream> DoExport(ExportViewModel model, ClaimsPrincipal user, int arcId)
        {
            // get our options
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<FileResult> ExportMarked(ExportViewModel model, int arcId)
        {
        ...
        /// <param name="user">User (object) making request</param>
        /// <returns>MemoryStream containing the Html</returns>
        public async Task<MemoryStream> DoExportMarked(ExportViewModel model, ClaimsPrincipal user, int arcId)
        {
            // get our options
            bool isHtml = model.isHtml;
            bool isCollapsible = model.isCollapsible;
