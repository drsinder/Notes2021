                        ...
                        if (line.Length > 52)  // Possible Note Header
                        {
                            ...
                            if (head.StartsWith("  Note ")) //new note found
                            {
                                if (newContent != null)  // have a note to write
                                {
                                    ...
                                    {
                                        //basenotes++;
                                        newHeader = await NoteDataManager.CreateNote(_db, _userManager, makeHeader, newContent.NoteBody, string.Empty, newContent.DirectorMessage, false, false);
                                    ...
                                    else // resp
                                    {
                                        ...
                                        await NoteDataManager.CreateResponse(_db, _userManager, makeHeader, newContent.NoteBody, string.Empty, newContent.DirectorMessage, false, false);
                                    }
                                }
